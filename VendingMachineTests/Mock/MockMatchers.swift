...
/// Invocation Count
public func invoke<T: Mockable>(_ name: T.MockedMethods, times: Int = 1) -> MatcherFunc<T> {
...
/// Equatable
public func invoke<T: Mockable, E: Equatable>(_ name: T.MockedMethods, atInvocation invocationIndex: Int = 0, withParameter parameter: E?, at parameterIndex: Int = 0) -> MatcherFunc<T> {
    return MatcherFunc { actualExpression, failureMessage in
...
/// Identity
public func invoke<T: Mockable, E: AnyObject>(_ name: T.MockedMethods, atInvocation invocationIndex: Int = 0, withIdenticalParameter parameter: E?, at parameterIndex: Int = 0) -> MatcherFunc<T> {
    return MatcherFunc { actualExpression, failureMessage in
...
/// Closure Matcher
public func invoke<T: Mockable, U>(_ name: T.MockedMethods, atInvocation invocationIndex: Int = 0, atParameterIndex parameterIndex: Int = 0, withMatcher matcher: @escaping ((U?) -> Bool?)) -> MatcherFunc<T> {
    return MatcherFunc { actualExpression, failureMessage in
